...
df_bf <- select(df_bf, ID, condition, date, r_eff1:quit_int )
...
df_bf <-df_bf %>% mutate_each(funs(as.numeric), -ID, -quit_int, -date, -condition) 
...
To DO: code for those new participants doing baseline and follow up measures
